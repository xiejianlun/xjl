...
public class HttpUtils {
	...
	public static String post(String url, Map<String, String> queryParas, String data, Map<String, String> headers) {
		...
		try {
			...
			out.write(data != null ? data.getBytes(CHARSET) : "".getBytes());//data为json字符串
			out.flush();
			out.close();
	...
	public static InputStream doJsonPostIO(String url, JSONObject json){
		 ...
		 try {
				 ...
				 if(res.getStatusLine().getStatusCode() == HttpStatus.SC_OK){
					 response = res.getEntity().getContent();// 返回json格式：
